...
export class AttachmentBackgroundImage extends React.Component {
  constructor (props) {
    super(props);
...
export class ViewAttachment extends React.Component {
  constructor (props) {
    super(props);
...
export class ViewAttachments extends React.Component {
  constructor (props) {
    super(props);
  }
